<template>
  <div class="questionnaire_list" ref="scrollbox">
    <div class="in_approval isAuditor">
      <ul>
        <li class="message">
          <div class="left_boxt">
            <div class="fontStyle">
          ...
          <div class="right_boxt">
            <div>
              <p class="boxTitle boxTitleColor">2017年上半年行政服务满意度调查表<span class="topicCount">(共20题)</span></p>
            </div>
            <div class="questionnaire_time">
              <div class="questionnaire_time_right">欧阳光光<span class="span_title">发布</span></div>
              <div class="questionnaire_time_left">2018年2月11日<span class="span_title">至</span>2018年2月11日</div>
            </div>
          </div>
          <div class="rightArrow_boxt"><i class="arrow_icon" :style='backgroundRightArrow'></i></div>
          <!--待审批-->
          <div class="approval_buttom">
            <div class="bottomBtn">马上参与</div>
          </div>
          <div class="approval_buttom canClick">
...
<style scoped lang="scss">
  /*@import '../../../../assets/css/system-fontsize';*/
  .questionnaire_list{
    height: 100%;
    overflow-y: auto;
  }
